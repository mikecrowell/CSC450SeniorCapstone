...
<asp:Content ID="SidebarContent" ContentPlaceHolderID="SidebarContent" runat="server">
    ...
    <div id="sidebar" align="left">
        <asp:RadioButton ID="RadioButton1" runat="server" GroupName = "group1"  Text = "User Activity Report" onclick = "ShowUserReport(this)" Checked="True" /> 
        <br /> 
        <br />
        <asp:RadioButton ID="RadioButton2" runat="server"  GroupName = "group1" Text = "File Download Report" onclick = "ShowFileReport(this)"/> 
    </div>
    <br />
</asp:Content>
